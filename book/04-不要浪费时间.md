...
- 备注：只对自己真想做的事有效，目标本身不想要时写再多也没用；研究找的多是学生、看的多是健康类习惯，搬到工作场景不一定同样管用

### 2. 开工前写下退出条件
<!-- 成本标签: 钱=0 时间=少 毅力=些 收益=大 口径=时间 -->
- 成本：立项时花 5 分钟写清「到某日期没达到某指标就停」，零金钱；执行时需要一点面子
- 说人话：开工前先写好「到某月某日还没达到某指标就停」。汇总实施意图研究的那份荟萃显示，这种「如果……就……」的写法也帮人从注定失败的事上撤下来。省下的是本来还会继续往里砸的全部时间。
- 收益：实施意图荟萃分析显示，预先设定的「如果……就……」同样促进「从失败路线上撤出」（disengagement from failing courses of action）；省下的是本来会继续投进去的全部时间
- 证据等级：B
- 来源：Gollwitzer, P. M., & Sheeran, P. (2006). Implementation intentions and goal achievement: A meta-analysis of effects and processes. Advances in Experimental Social Psychology, 38, 69–119. <https://doi.org/10.1016/S0065-2601(06)38002-1>
- 备注：「肯撤出」是多项研究汇总里的一个分项结论，没有单独算过省下多少时间；退出条件要在刚开工、情绪还冷静时定，事后再定会被已经投进去的成本带偏（见第 3 条，只看未来投入和未来回报）
...
- 备注：Arkes & Blumer 的剧院实验只核实到方向（票价付得更高的人半年里看戏更多），各组具体看了几场还没核到原文（待核实）；Roth 等发现这种影响会随时间变淡，年纪大的人受影响更小
...
- 备注：Buehler 那项只找了加拿大大学生，是单独一项研究、人也少（37 人和每组约 40 人）；照同类项目的历史数据来估（参考类预测）在工程上怎么做，见 Flyvbjerg；Halkjelsvik 汇总多项研究后指出，估少比估多更常见，但差多少随任务和研究方法变化很大
...
- 备注：站会实验做的是 5 人小组在实验室里的任务，长会和大型会议不能照搬；Leach 测的是参会者自己觉得效果如何，不是实际产出
...
- 备注：争议：Rogelberg 2006 发现会议多少和幸福感之间不是一头倒，工作上高度依赖别人的岗位，会议多反而不坏；也没有研究把「改用文字异步沟通」和开会直接比过，这条是作者自己的推论
...
- 备注：Kruger & Evans 只从摘要核实到方向，具体百分比没核到原文；拆得过细本身也耗时间，以「每个子任务能在一次坐下来的时间里做完」为度
...
- 备注：研究验证的是别人定的截止日期管用，自己给自己定的（时间盒、番茄钟一类）没人直接测过，是照着推的；把自己定的日期告诉别人，它就更接近别人定的那种
...
- 备注：算法：时薪 = 一个月税后收入 ÷ 一个月实际工作小时；某项家务的外包单价低于时薪、且省下的时间你确实会用在收入或休息上，就外包。只给方法，不给结论，因为每个人的时薪和外包价不同；Whillans 测的是花钱买时间之后人更不更开心，不是省下了多少小时

### 10. 给短视频和无目的刷屏设硬上限
<!-- 成本标签: 钱=0 时间=少 毅力=是 收益=大 口径=时间 -->
- 成本：毅力大；需要关推送、删应用或设应用限时
- 说人话：中国人平均每天上网 5 小时 37 分，上网的人是 6 小时 3 分；2018 年同一口径还只有 2 小时 42 分。这是本节时间账里数字最大的一项，砍掉其中一小时，一年就多出 365 小时。
...
- 备注：互联网使用时间包含工作、学习和社交，不全是浪费；C 级是因为没有研究量化「限制后省回多少并用到哪里」，只有总量统计。其中「刷别人过得怎么样」这一类有随机试验测过省回多少、情绪变了多少，见第 3 节第 21 条
...
- 说人话：多数用了很多年 Word 的人仍然在点工具栏，而对照实验里快捷键比菜单和工具栏图标都快。学一次是一次性成本，之后每天每次操作都在回本，做同一类工作越久赚得越多。
...
- 备注：争议：Chatterjee 等汇总多项研究后指出，通勤长短和整体生活满意度之间还看不出稳定的关系，人们大体上能用更好的工作或住房把长通勤的损失换回来；交通活动的统计算的是所有出行，不只是通勤；能错峰上下班，同样的路也能跑得更短
